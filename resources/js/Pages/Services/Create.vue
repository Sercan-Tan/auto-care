...
const addSelectedCategories = () => {
    ...
    // Seçilen her kategori için bir servis işlemi ekle
...
const removeServiceItem = (index) => {
    // Listeden kaldırırken seçili kategorilerden de kaldır
...
// Form gönderme
const submit = () => {
    form.post(route('services.store', props.vehicle.id));
};
</script>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                Yeni Servis Kaydı - {{ vehicle.plate_no }}
            </h2>
        </template>
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div v-if="form.items.length === 0" class="text-gray-500 dark:text-gray-400 text-center py-8">
                                    Henüz servis işlemi seçilmedi. Yukarıdaki "İşlem Seç" düğmesine tıklayarak işlem ekleyebilirsiniz.
                                </div>
        ...
        <div v-if="isModalOpen" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full max-h-[80vh] flex flex-col">
                ...
                <div class="p-4 overflow-y-auto flex-grow">
                    <div class="space-y-1">
                        <!-- Kategorileri doğrudan burada işleyelim -->
                ...
                <div class="p-4 border-t border-gray-200 dark:border-gray-700 flex justify-end">
                    ...
                    >
                        {{ selectedCategories.length }} Kategori Ekle
                    </button>
                </div>
            </div>
        </div>
